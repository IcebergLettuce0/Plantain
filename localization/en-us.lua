return {
  ...
  misc = {
    dictionary = {
      ...
      pl_config_decks = "Enable decks",
      pl_config_seals = "Enable seals",
      pl_config_spectral_cards = "Enable Spectral cards",
      pl_config_vouchers = "Enable Vouchers",
      pl_credits_programming = "Programming: IcebergLettuce, NachitoSMO",
      pl_credits_art = "Art: IcebergLettuce",
      pl_credits_idea = "Idea Guys: AtomicLight, BurntFrenchToast, TomatoIcecream, SpadeALay",
    },
